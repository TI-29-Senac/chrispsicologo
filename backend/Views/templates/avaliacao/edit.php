...
<form action="/backend/avaliacoes/atualizar" method="POST">
    <input type="hidden" name="id_avaliacao" value="<?= $avaliacao['id_avaliacao'] ?>">
    
    <label for="id_cliente">ID do Cliente:</label>
    <input type="number" id="id_cliente" name="id_cliente" value="<?= $avaliacao['id_cliente'] ?>" disabled><br><br>

    <label for="id_profissional">ID do Profissional Avaliado:</label>
    <input type="number" id="id_profissional" name="id_profissional" value="<?= $avaliacao['id_profissional'] ?>" disabled><br><br>
