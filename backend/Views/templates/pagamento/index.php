<?php 
// Verifica se a variável $pagamentos existe e não está vazia para evitar erros.
if (!empty($pagamentos)): 
?>
    <table>
        <thead>
        ...
        <?php foreach($pagamentos as $pagamento): ?>
            <tr>
                ...
                <td>R$<?= number_format($pagamento['valor_consulta'], 2, ',', '.'); ?></td>
                <td>R$<?= number_format($pagamento['sinal_consulta'], 2, ',', '.'); ?></td>
